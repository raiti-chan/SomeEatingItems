...
public class SomeEatingItemsCorePlugin implements IFMLLoadingPlugin {
	...
	public String[] getASMTransformerClass () {
		return new String[]{
				SomeEatingItemsTransformer.class.getName()
		};
	}
	...
	public String getModContainerClass () {
		return SomeEatingItemsDummyContainer.class.getName();
	}
